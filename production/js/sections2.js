...
function ActiveRow({
  ...
  }, /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", { style: { fontSize: playing ? 9 : 13, lineHeight: 1, marginRight: 1, verticalAlign: 'middle' } }, playing ? '▐▐' : '▶'), playing ? 'Pause' : 'Listen')), t.youtubeUrl && t.youtubeUrl !== '#' && /*#__PURE__*/React.createElement("a", {
    href: t.youtubeUrl,
    target: "_blank",
...
function Transmissions({
  ...
  const moodFadeRightRef = React.useRef(null);
  const TX = getMixes();
  ...
  return /*#__PURE__*/React.createElement("section", {
  ...
  })), /*#__PURE__*/React.createElement("div", { className: 'wt-ep-fade-hint-left', ref: moodFadeLeftRef }), /*#__PURE__*/React.createElement("div", { className: 'wt-ep-fade-hint', ref: moodFadeRightRef })), /*#__PURE__*/React.createElement(ActiveRow, {
    t: activeTx,
    playing: playing,
    ...
    return (narrow && !tablet) ? /*#__PURE__*/React.createElement("div", {
      ...
      style: playBtn,
      "aria-label": `${isActive && playing ? 'Pause' : 'Play'} ${t.title}`
    }, /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", { style: { fontSize: isActive && playing ? 8 : 12, lineHeight: 1, marginRight: 1, verticalAlign: 'middle' } }, isActive && playing ? '▐▐' : '▶'), isActive && playing ? 'PAUSE' : 'PLAY')), t.youtubeUrl && t.youtubeUrl !== '#' && /*#__PURE__*/React.createElement("a", {
      href: t.youtubeUrl,
      target: "_blank",
      rel: "noopener noreferrer",
      onClick: e => e.stopPropagation(),
      ...
      style: playBtn,
      "aria-label": `${isActive && playing ? 'Pause' : 'Play'} ${t.title}`
    }, /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", { style: { fontSize: isActive && playing ? 8 : 12, lineHeight: 1, marginRight: 1, verticalAlign: 'middle' } }, isActive && playing ? '▐▐' : '▶'), isActive && playing ? 'PAUSE' : 'PLAY')), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        gap: 10,
        marginTop: 5
