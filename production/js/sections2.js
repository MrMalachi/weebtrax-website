...
function ActiveRow({
  ...
  }, /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", { style: { fontSize: playing ? 9 : 13, lineHeight: 1 } }, playing ? '▐▐' : '▶'), playing ? ' Pause' : ' Listen')), t.youtubeUrl && t.youtubeUrl !== '#' && /*#__PURE__*/React.createElement("a", {
    href: t.youtubeUrl,
    target: "_blank",
...
function Transmissions({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    return (narrow && !tablet) ? /*#__PURE__*/React.createElement("div", {
      ...
      style: playBtn,
      "aria-label": `${isActive && playing ? 'Pause' : 'Play'} ${t.title}`
    }, /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", { style: { fontSize: isActive && playing ? 8 : 12, lineHeight: 1 } }, isActive && playing ? '▐▐' : '▶'), isActive && playing ? ' PAUSE' : ' PLAY')), t.youtubeUrl && t.youtubeUrl !== '#' && /*#__PURE__*/React.createElement("a", {
      href: t.youtubeUrl,
      target: "_blank",
      rel: "noopener noreferrer",
      onClick: e => e.stopPropagation(),
      ...
      style: playBtn,
      "aria-label": `${isActive && playing ? 'Pause' : 'Play'} ${t.title}`
    }, /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", { style: { fontSize: isActive && playing ? 8 : 12, lineHeight: 1 } }, isActive && playing ? '▐▐' : '▶'), isActive && playing ? ' PAUSE' : ' PLAY')), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        gap: 10,
        marginTop: 5
