...
const WT2 = {
  ...
  panel2: '#181b22',
  sink: '#070809',
  line: 'rgba(214,209,198,0.14)',
  line2: 'rgba(214,209,198,0.28)',
  lineHot: 'rgba(214,209,198,0.5)',
  fill: 'rgba(214,209,198,0.04)',
  fill2: 'rgba(214,209,198,0.07)',
  // ink — pale cream / ash
  ink: '#e6e1d4',
  body: 'rgba(230,225,212,0.72)',
  dim: 'rgba(230,225,212,0.5)',
  faint: 'rgba(230,225,212,0.3)',
