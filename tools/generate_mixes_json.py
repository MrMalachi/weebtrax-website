...
# Complete SoundCloud track list fetched from WeebTrax profile (soundcloud.com/weebtrax)
SC = [
    ...
    ("Lo-Fi House Mix | Break Everything Into DnB", "https://soundcloud.com/weebtrax/lo-fi-house-mix-break-everything-into-dnb"),
    ...
    ("Lo-Fi House & Jungle/DnB Mix | Don't Talk About Me Like I'm A Machine. I'm Not That", "https://soundcloud.com/weebtrax/lo-fi-house-junglednb-mix-dont-talk-about-me-like-im-a-machine-im-not-that"),
...
# YouTube titles that differ from their SoundCloud counterparts
SC_MANUAL = {
    "Lo-Fi House Mix | Retrospect": "https://soundcloud.com/weebtrax/lo-fi-house-music-retrospect-mix",
    "Lo-Fi House Mix | Love Is Contagious": "https://soundcloud.com/weebtrax/lo-fi-house-music-love-is-contagious-mix",
    "Lo-Fi Ambient Essentials | Out-of-Body Experience Trax": "https://soundcloud.com/weebtrax/lo-fi-ambient-essentials-out-of-body-trax",
    "Lo-Fi House Music | Heartbreaks & Breakbeat Mix (Batman Beyond)": "https://soundcloud.com/weebtrax/lo-fi-house-music-breakups-breakbeat-mix-batman-beyond",
    "Lo-Fi House Essentials | Sounds Like I'm High, Feels Like I'm Floating Trax": "https://soundcloud.com/weebtrax/lo-fi-house-essentials-sounds",
}

# Build SoundCloud lookup by normalized full title
sc_by_norm = {normalize(title): url for title, url in SC}
...
for i, (yt_id, yt_title, duration) in enumerate(YT_sorted, 1):
    sc_url = SC_MANUAL.get(yt_title) or sc_by_norm.get(normalize(yt_title))
